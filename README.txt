...
Καλησπέρα,για το command recordPatientExit,αν το recordID που δίνει ο χρήστης έχει ήδη
κάποιο exitDate,να το ενημερώσουμε ή να εμφανίσουμε κάποιο μήνυμα λάθους ? Ευχαριστώ
